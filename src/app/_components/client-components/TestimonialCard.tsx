      ...
      <div className="flex flex-row gap-5 justify-center items-center w-full h-[30rem] overflow-x-hidden relative">
        {TestimonialData.map((testimonial, index) => (
          ...
          >
            ...
            >
              <div className="p-[2px] rounded-[calc(0.75rem+2px)] bg-neutral-100 absolute top-0 left-[calc(50%-5rem)] -translate-y-[70%] lg:left-[calc(50%-100px)] drop-shadow-2xl shadow-2xl">
                <Image
                  width={200}
                  height={200}
